...
#include "ns3/streaming-module.h"
...
//	cmd.AddValue ("nWifi", "Number of wifi STA devices", nWifi);
	...
	if (verbose)
	{
		LogComponentEnable ("VideoPush", LOG_LEVEL_ALL);
	}
